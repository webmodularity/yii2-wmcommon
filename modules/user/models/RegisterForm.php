...
class RegisterForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'unique', 'targetClass' => '\wmu\models\User', 'message' => 'This username is already in use.'],
    ...
    public function registerUser($roleId, $statusId) {
        if ($this->validate()) {
            ...
            $user->created_at = Yii::$app->formatter->asMysqlDatetime();
             if ($user->save()) {
                 UserLog::add(UserLog::ACTION_CREATE, UserLog::RESULT_SUCCESS, $user->person_id);
                 return $user;
             }
        }
